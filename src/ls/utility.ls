  ...
  ..service \i18n, <[$rootScope]> ++ ($rootScope) ->
    ret = do
      ...
      db: do
        ...
        'Add Chart': zh: "加入圖表"
        'add': zh: "加入"
        'You can only add charts that are owned by you': zh: "只有圖表的擁有者才能把圖表加進來喔！"
        'or Create from Scratch': zh: "或從頭打造一個"
        'Members': zh: "成員"
        'Charts': zh: "圖表"
        # Language
        'zh': zh: "中文"
        ...
        'title shown in social media': zh: "分享時顯示的標題"
        'summary shown in social media': zh: "分享時顯示的描述"
        'e.g., data source': zh: "註腳，如：資料來源"
