...
(function(){
  ...
  config = {
    ...
    js: {
      ...
      view: ['/js/sched.js', '/js/plotdb/main.js', '/js/plotdb/type.js', '/js/plotdb/chart.js', '/js/plotdb/theme.js', '/js/plotdb/data.js', '/js/plotdb/config.js', '/js/plotdb/util.js', '/js/share/config.js', '/js/chart/view.js'],
