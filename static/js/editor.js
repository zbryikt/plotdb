...
x$.controller('plEditor', ['$scope', '$http', '$timeout', '$interval', '$sce', 'plConfig', 'dataService', 'chartService', 'paletteService', 'themeService', 'plNotify'].concat(function($scope, $http, $timeout, $interval, $sce, plConfig, dataService, chartService, paletteService, themeService, plNotify){
  import$($scope, {
    plConfig: plConfig,
