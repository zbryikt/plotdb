...
x$.service('chartService', ['$rootScope', '$http', 'plConfig', 'sampleChart', 'IOService', 'baseService', 'dataService', 'eventBus'].concat(function($rootScope, $http, plConfig, sampleChart, IOService, baseService, dataService, eventBus){
  ...
  object = function(src, lazy){
    var datasets, k, ref$, v, promises, res$, this$ = this;
    ...
    function fn$(it){
      if (it.dataset) {
        return datasets[it.dataset] = true;
      }
    }
  };
  object.prototype = {
