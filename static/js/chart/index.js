...
x$.service('chartService', ['$rootScope', 'sampleChart', 'IOService', 'baseService'].concat(function($rootScope, sampleChart, IOService, baseService){
...
x$.controller('chartList', ['$scope', '$http', 'IOService', 'dataService', 'chartService'].concat(function($scope, $http, IOService, dataService, chartService){
  $scope.charts = [];
  return Promise.all([
