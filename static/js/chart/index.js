...
x$.service('chartService', ['$rootScope', '$http', 'sampleChart', 'IOService', 'baseService', 'dataService'].concat(function($rootScope, $http, sampleChart, IOService, baseService, dataService){
