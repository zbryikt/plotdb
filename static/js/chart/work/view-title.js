...
import$(plotdb.view.chart.prototype, {
  ...
  attach: function(root){
    var ref$, chart, theme, head, foot, iroot, iiroot, headbox, footbox, resize, newClass, e;
    this._.root = root;
    ref$ = {
